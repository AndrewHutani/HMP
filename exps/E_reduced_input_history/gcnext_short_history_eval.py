...
from models.gcnext.modified_model import GCNext as ModifiedModel
...
# ------------------------------------------------------------------------
config.motion.h36m_input_length = INPUT_LENGTH
config.motion.h36m_input_length_dct = INPUT_LENGTH
config.motion_mlp.seq_len = INPUT_LENGTH 
config.motion.h36m_target_length_train = SINGLE_PASS_PREDICTION_LENGTH # This naming convention is super confusing

parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)
parser.add_argument('--model-pth', type=str, default=MODEL_CHECKPOINT, help='=encoder path')
...
if INPUT_LENGTH == 50:
    ...
    print(f"Using modified model for input length {INPUT_LENGTH}")
    model = ModifiedModel(config, args.dyna)
...
log_filename = "exps/E_reduced_input_history/performance_logs/" + OUTPUT_LOG_FILENAME
