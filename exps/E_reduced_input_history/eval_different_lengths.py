...
gcn_single_pass_times = [17.79, 17.89,  18.19,  22.65,  23.04,  25.34] # Single forward pass times in ms
gcn_jitter =            [3.32,  1.54,   1.02,   3.14,   2.73,   6.85] # Jitter times in ms

gcn_files = [
    save_directory + "gcnext_hist_length_8.txt",
    save_directory + "gcnext_hist_length_12.txt",
    save_directory + "gcnext_hist_length_16.txt",
    save_directory + "gcnext_hist_length_20.txt",
...
ax1.grid(True)
fig1.tight_layout()
fig1.savefig(figure_directory + 'physmop_performance_different_lengths.png', dpi=dpi)
...
ax2.grid(True)
fig2.tight_layout()
fig2.savefig(figure_directory + 'physmop_bar_performance.png', dpi=dpi)
...
ax3.grid(True)
fig3.tight_layout()
fig3.savefig(figure_directory + 'gcnext_performance_different_lengths.png', dpi=dpi)
...
ax4.grid(True)
fig4.tight_layout()
fig4.savefig(figure_directory + 'gcnext_bar_performance.png', dpi=dpi)
...
fig.savefig(figure_directory + 'barplot_legend.png', bbox_inches='tight', dpi=300, pad_inches=0.2)
plt.close(fig)