...
experiment_directory = "exps/B_input_length/"
...
def plot_and_save(upper_data, lower_data, 
    ...
    if y_limits is not None:
        plt.ylim(y_limits)
    save_name = f"{experiment_directory}/figures/mpjpe_{model_name.lower()}_{branch.lower()}_upper_lower.png"
...
def export_upper_lower_mean_error_csv(
    ...
    filename= experiment_directory + "performance_logs/" + filename
...
upper_data_mean, upper_data_std = parse_physmop_data(experiment_directory + "performance_logs/physmop_data_mpjpe_log.txt", "upper body")
lower_data_mean, lower_data_std = parse_physmop_data(experiment_directory + "performance_logs/physmop_data_mpjpe_log.txt", "lower body")
upper_physics_mean, upper_physics_std = parse_physmop_data(experiment_directory + "performance_logs/physmop_physics_mpjpe_log.txt", "upper body")
lower_physics_mean, lower_physics_std = parse_physmop_data(experiment_directory + "performance_logs/physmop_physics_mpjpe_log.txt", "lower body")
upper_fusion_mean, upper_fusion_std = parse_physmop_data(experiment_directory + "performance_logs/physmop_fusion_mpjpe_log.txt", "upper body")
lower_fusion_mean, lower_fusion_std = parse_physmop_data(experiment_directory + "performance_logs/physmop_fusion_mpjpe_log.txt", "lower body")

upper_gcn_mean, upper_gcn_std = parse_gcn_data(experiment_directory + "performance_logs/gcnext_mpjpe_log.txt", "upper body")
lower_gcn_mean, lower_gcn_std = parse_gcn_data(experiment_directory + "performance_logs/gcnext_mpjpe_log.txt", "lower body")
...
upper_gcn_on_amass_mean, upper_gcn_on_amass_std = parse_physmop_data(experiment_directory + "performance_logs/gcnext_on_amass.txt", "upper body")
lower_gcn_on_amass_mean, lower_gcn_on_amass_std = parse_physmop_data(experiment_directory + "performance_logs/gcnext_on_amass.txt", "lower body")
...
fig.savefig(
    experiment_directory + "figures/legend_upper_lower.png",
    dpi=300,
    bbox_inches="tight",
