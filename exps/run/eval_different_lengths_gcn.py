...
prediction_time_data = [70.79, 54.42, 54.81, 68.43, 70.58, 100.80]
dummy_latency_data = [71.17, 54.80, 55.18, 68.85, 71.05, 101.31]  # Dummy latency data in ms
...
ax1.grid(True)
fig1.tight_layout()
fig1.savefig('figures/gcnext_performance_different_lengths.png', dpi=300)
...
ax.set_ylim(ax2.get_ylim())  # Adjust y-axis limit as needed
...
fig2.tight_layout()
fig2.savefig('figures/gcnext_bar_performance.png', dpi=300)