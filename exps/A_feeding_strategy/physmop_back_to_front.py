...
if __name__ == "__main__":
    ...
    log_files = [save_directory + "physmop_data_mpjpe_log_back_to_front_test.txt", 
                 save_directory + "physmop_physics_mpjpe_log_back_to_front_test.txt", 
                 save_directory + "physmop_fusion_mpjpe_log_back_to_front_test.txt"]
