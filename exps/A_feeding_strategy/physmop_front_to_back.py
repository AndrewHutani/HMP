...
if __name__ == "__main__":
    ...
    save_directory = "exps/A_feeding_strategy/performance_logs/"
    log_files = [save_directory + "physmop_data_mpjpe_log_front_to_back_test.txt", 
                 save_directory + "physmop_physics_mpjpe_log_front_to_back_test.txt", 
                 save_directory + "physmop_fusion_mpjpe_log_front_to_back_test.txt"]
