...
DATASET_FOLDERS = {
                    'H36M':  'data/data_processed/h36m_train_%d.pkl' % total_length,
                    'AMASS':  'data/data_processed/amass_train_%d.pkl' % total_length,
                    'PW3D':  'data/data_processed/pw3d_test_%d.pkl' % total_length,
                                  }
...
SMPL_MODEL_PATH = 'data/smpl_official/processed_basicModel_neutral_lbs_10_207_0_v1.0.0.pkl'
SMPLH_N_PATH = 'data/smpl_official/neutral/model.npz'
